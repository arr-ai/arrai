// Source: https://cs.lmu.edu/~ray/notes/xmlgrammar/
package bootstrap

// TODO: Get this working. Possibly add /{#x([[:hexdigit:]]+)} to the grammar.
var _ = xmlGrammar
var xmlGrammar = `
// XML Grammar
//
...
// 
// This reference was made by copying and pasting from the XML Spec at
// http://www.w3.org/TR/REC-xml and including all the errata at
// http://www.w3.org/XML/xml-V10-2e-errata (upto E44, which is as far as they
// had gotten when I made this page).
//
// The Syntax of XML
