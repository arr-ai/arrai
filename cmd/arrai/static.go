...
func internalBuildMainArrai() (*asset, error) {
	...
	info := bindataFileInfo{name: "internal/build/main.arrai", size: 493, mode: os.FileMode(420), modTime: time.Unix(1599396586, 0)}
