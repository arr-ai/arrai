...
func TestEvalCondWithControlVar(t *testing.T) {
	// 	t.Parallel()
	AssertCodesEvalToSameValue(t, `1`, `let a = 1; a cond {(1 + 2 :1, (2) :2}`)
...
// 	t.Parallel()
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(((1>0))&&((2>1)):1))", "(1) cond (1 > 0 && 2 > 1 : 1)")
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(((1>0))||((2>1)):1))", "(1) cond (1 > 0 || 2 > 1 : 1)")
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(((1>0))||((2>1)):1,*:11))", "(1) cond (1 > 0 || 2 > 1 : 1, * : 11)")
// }
...
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(1:1,(2+1):3))", "(1) cond (1 : 1, 2 + 1 : 3,)")
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(1:1,(2+1):3,*:4))", "(1) cond (1 : 1, 2 + 1 : 3, * : 4)")
// 	AssertCodesEvalToSameValue(t, "((control_var:1),(1:1,(2+1):3,*:4))", "(1) cond (1 : 1, 2 + 1 : 3, * : 4,)")
